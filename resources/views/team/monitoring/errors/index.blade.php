        ...
        <div class="content-section">
            <table class="errors-table">
                ...
                <tbody>
                    ...
                    <tr class="error-row-{{ $error->is_resolved ? 'resolved' : 'unresolved' }}">
                        <td class="time-cell">{{ $error->created_at->format('Y-m-d H:i:s') }}</td>
                        <td><span class="level-badge level-{{ strtolower($error->severity) }}">{{ strtoupper($error->severity) }}</span></td>
                        <td class="message-cell">{{ $error->error_message }}</td>
                        <td>
                        ...
                        <td>
                            ...
                            @if(!$error->is_resolved)
                                <form action="{{ route('team.errors.resolve', $error) }}" method="POST" style="display:inline;">
                                    @csrf
