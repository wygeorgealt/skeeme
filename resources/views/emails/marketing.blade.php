...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">
                <p>Dear <strong>{{ $contactName ?? 'Administrator' }}</strong>,</p>
                <br>
                <p>We're reaching out to <strong>{{ $schoolName ?? 'your institution' }}</strong> because we believe you deserve better tools to manage your school operations.</p>
                <br>
            ...
            <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 16px; border-radius: 8px; margin-top: 24px;">
                <p style="font-size: 14px; color: #92400e; margin: 0;">{{ $customMessage }}</p>
            </div>
            @endif
        </div>
        ...
        <div class="footer">
            ...
            <div class="unsubscribe">
                <p>You received this email because we thought Skeeme could help {{ $schoolName ?? 'your institution' }}.</p>
