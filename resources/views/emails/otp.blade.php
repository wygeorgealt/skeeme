...
@section('content')
<h1 style="font-size: 28px; font-weight: 700; color: #111827; letter-spacing: -0.02em; margin: 0 0 16px;">Verify your identity</h1>

<p style="font-size: 16px; color: #374151; line-height: 1.6; margin: 0 0 24px;">
    We need to verify your identity for your Skeeme account associated with 
