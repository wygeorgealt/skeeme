<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background: #ffffff; color: #1a1a1a; padding: 0; margin: 0;">
    ...
    <div style="padding: 50px 30px; max-width: 600px; margin: 0 auto; line-height: 1.8;">
        ...
        <p style="margin: 0 0 20px 0; font-size: 15px; line-height: 1.8; color: #444;">
            Congratulations! 🎉 Your subscription has been successfully upgraded to <strong>{{ $planName }}</strong>. You now have access to all premium features.
        </p>
        ...
        <div style="background: #f8f9fa; padding: 25px; border-radius: 12px; margin: 30px 0; border-left: 4px solid #667eea;">
            ...
            <table style="width: 100%; font-size: 14px;">
                <tr style="border-bottom: 1px solid #e0e0e0;">
                    ...
                    <td style="padding: 12px 0; text-align: right; color: #1a1a1a; font-weight: 600;">{{ $planName }}</td>
                </tr>
                <tr style="border-bottom: 1px solid #e0e0e0;">
                    <td style="padding: 12px 0; color: #666; font-weight: 600;">Billing Cycle</td>
                    <td style="padding: 12px 0; text-align: right; color: #1a1a1a; font-weight: 600;">{{ ucfirst($billingPeriod) }}</td>
                </tr>
                <tr style="border-bottom: 1px solid #e0e0e0;">
                    <td style="padding: 12px 0; color: #666; font-weight: 600;">Amount</td>
                    <td style="padding: 12px 0; text-align: right; color: #1a1a1a; font-weight: 600;">{{ $subscription->getFormattedPrice('NGN') }}</td>
                </tr>
                <tr>
                    <td style="padding: 12px 0; color: #666; font-weight: 600;">Valid Until</td>
                    <td style="padding: 12px 0; text-align: right; color: #1a1a1a; font-weight: 600;">{{ $subscription->expiry_date->format('M d, Y') }}</td>
                </tr>
            </table>
        </div>
        ...
        <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 18px 20px; border-radius: 8px; margin: 30px 0;">
            <p style="margin: 0; font-size: 13px; color: #78350f; line-height: 1.6;">
                ...
                Your subscription will automatically renew on {{ $subscription->expiry_date->format('M d, Y') }}. You can manage or cancel your subscription anytime in your account settings.
            </p>
        </div>

        <!-- CTA Buttons -->
        <div style="text-align: center; margin: 35px 0;">
            <a href="{{ config('app.url') . '/dashboard' }}" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 15px 45px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 15px; margin: 0 8px;">
                Go to Dashboard
            </a>
        </div>
        ...
        <div style="background: #f8f9fa; padding: 25px; border-radius: 12px; margin: 30px 0;">
            ...
            <p style="margin: 8px 0; font-size: 14px;">
                <a href="{{ config('app.url') . '/courses' }}" style="color: #667eea; text-decoration: none; font-weight: 600;">📚 Browse Courses</a>
            </p>
            <p style="margin: 8px 0; font-size: 14px;">
                <a href="{{ config('app.url') . '/account/settings' }}" style="color: #667eea; text-decoration: none; font-weight: 600;">⚙️ Account Settings</a>
            </p>
            <p style="margin: 8px 0; font-size: 14px;">
                <a href="{{ config('app.url') . '/help' }}" style="color: #667eea; text-decoration: none; font-weight: 600;">❓ Help & Support</a>
            </p>
        </div>
