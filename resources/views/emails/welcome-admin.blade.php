...
<body>
    <div class="container">
        ...
        <div class="hero">
            ...
            <p>Get ready to transform education at {{ $schoolName }}</p>
        </div>

        <div class="content">
            <div class="card">
                <h3>Account Created Successfully</h3>
                <p>Hi {{ $user->first_name }}, your admin account has been created. We're excited to have you on board!</p>
            </div>
            ...
            <div class="button-container">
                <a href="{{ route('onboarding.admin') }}" class="button">Complete Your Setup</a>
            </div>
