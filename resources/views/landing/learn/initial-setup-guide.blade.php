...
jane.smith@school.edu,Jane Smith,T002,English,"Form 1A, Form 1B"</div>
        ...
        <div class="section" data-aos="fade-up">
            ...
            <div class="next-section">
                ...
                <p>Head over to the <a href="{{ url('learn/documentation/inviting-users') }}">Inviting Users</a> guide to start building your school community.</p>
            </div>
        </div>
        ...
        <div class="section" data-aos="fade-up">
            ...
            <ul class="feature-list">
                <li>Check our <a href="{{ url('learn/documentation') }}" style="color: #3b82f6;">full documentation</a> for detailed articles</li>
