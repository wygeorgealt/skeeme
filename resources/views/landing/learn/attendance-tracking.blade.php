...
<div class="guide-container">
    <div class="breadcrumb" data-aos="fade-down">
        <a href="{{ url('learn/documentation') }}">Documentation</a> / Attendance Tracking
    </div>
    ...
    <section class="guide-content">
        ...
        <div class="next-section">
            ...
            <p>Learn to create comprehensive reports for all stakeholders. Check out our <a href="{{ url('learn/documentation/generating-reports') }}">Generating Reports</a> guide.</p>
        </div>
    </section>
</div>
