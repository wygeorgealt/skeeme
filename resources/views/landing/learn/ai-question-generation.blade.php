...
<div class="guide-container">
    <div class="breadcrumb" data-aos="fade-down">
        <a href="{{ url('learn/documentation') }}">Documentation</a> / AI Question Generation
    </div>
    ...
    <section class="guide-content">
        ...
        <div class="section" data-aos="fade-up">
            ...
            <div class="next-section">
                ...
                <p>Learn how to use AI to automatically grade essays and short answers. Check out our <a href="{{ url('learn/documentation/ai-auto-grading') }}">AI Auto-Grading Workflow</a> guide.</p>
            </div>
        </div>
    </section>
</div>
