    ...
    <section class="relative z-10 pt-32 pb-24 lg:pt-40 lg:pb-40 overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            ...
            <div data-aos="fade-up" data-aos-delay="250" class="flex flex-col sm:flex-row items-center gap-3 justify-center mb-16">
                ...
                <flux:button href="#solutions" variant="ghost" class="!rounded-xl !px-6 !py-3 !text-sm !font-extrabold !text-slate-900 hover:!text-indigo-600 hover:!bg-indigo-50">
                    Explore Platform <flux:icon.arrow-right variant="micro" class="ml-2" />
                </flux:button>
            </div>
