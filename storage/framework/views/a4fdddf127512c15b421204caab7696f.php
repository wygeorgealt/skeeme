...
<p>
    Hi <?php echo e($user->first_name ?? 'there'); ?>,<br><br>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 32px 0;">
    <tr>
        <td width="33.33%" align="center" style="padding: 20px; background-color: #F8FAFC; border-radius: 16px 0 0 16px;">
            <div style="font-size: 24px; font-weight: 800; color: #8B5CF6;"><?php echo e($sessionsCount ?? 0); ?></div>
        ...
        <td width="33.33%" align="center" style="padding: 20px; background-color: #F1F5F9; border-left: 1px solid #E2E8F0; border-right: 1px solid #E2E8F0;">
            <div style="font-size: 24px; font-weight: 800; color: #6366F1;"><?php echo e($creditsSpent ?? 0); ?></div>
        ...
        <td width="33.33%" align="center" style="padding: 20px; background-color: #F8FAFC; border-radius: 0 16px 16px 0;">
            <div style="font-size: 24px; font-weight: 800; color: #F59E0B;"><?php echo e($streakCount ?? 0); ?> 🔥</div>
...
<div class="glass-box">
    ...
    <p style="font-size: 14px; margin-bottom: 0;">
        Consistent study habits are the shortcut to mastery. You've been most active on <strong><?php echo e($topActivity ?? 'Quiz assignments'); ?></strong>. Keep pushing!
    </p>
</div>

<div style="margin-top: 40px; text-align: left;">
    <a href="<?php echo e(config('app.url')); ?>/dashboard" class="btn">View Full Analytics</a>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.email_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views/emails/stats_v2.blade.php ENDPATH**/ ?>