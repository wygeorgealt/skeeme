						...
						<tbody><tr>
							<td width="100%" style="font-weight: 400; text-align: center; vertical-align: middle;">
								<div style="padding: 10px 0;">
									<img src="<?php echo e(asset('images/skeemeword.png')); ?>" width="160" alt="Skeeme" style="display: inline-block;">
								</div>
							</td>
						</tr></tbody>
					</table>
			...
			<table align="center" class="container" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color: #8B5CF6; border-radius: 0; color: #ffffff; width: 640px; margin: 0 auto;" width="640">
				<tbody><tr>
					<td class="hero-padding" style="font-weight: 400; text-align: left; vertical-align: top; padding: 40px 40px 0;">
						<!-- Label -->
						<h2 style="margin: 0 0 12px; color: #0c0914; font-family: 'Orbit', Helvetica, sans-serif; font-size: 12px; font-weight: 800; letter-spacing: 2px; line-height: 1.2; text-align: center; text-transform: uppercase; opacity: 0.9;"><?php echo $__env->yieldContent('hero-label', 'Next-Gen Learning Assistant'); ?></h2>

						<!-- Headline -->
						<h1 class="hero-h1" style="margin: 0 0 32px; color: #0c0914; font-family: 'Instrument Sans', Helvetica, sans-serif; font-size: 44px; font-weight: 800; letter-spacing: -1.5px; line-height: 1.1; text-align: center;"><?php echo $__env->yieldContent('hero-title'); ?></h1>
						...
						<div style="background: #0c0914; border-radius: 16px; height: 240px; display: flex; align-items: center; justify-content: center; margin: 0 auto 40px; overflow: hidden; position: relative; border: 1px solid rgba(255,255,255,0.1);">
							...
							<div style="position: relative; z-index: 1; text-align: center;">
								<div style="width: 72px; height: 72px; background: #8B5CF6; border-radius: 20px; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center; box-shadow: 0 0 30px rgba(139, 92, 246, 0.4);">
									<?php echo $__env->yieldContent('hero-icon'); ?>
								</div>
								<p style="color: #8B5CF6; font-family: 'Orbit', Helvetica, sans-serif; font-size: 14px; font-weight: 800; margin: 0; letter-spacing: 2px; text-transform: uppercase;"><?php echo $__env->yieldContent('hero-subtitle'); ?></p>
							</div>
						</div>
					</td>
				</tr></tbody>
				...
				<tbody><tr>
					<td class="footer-padding" style="padding: 40px; text-align: center;">
						<div style="padding-bottom: 20px; text-align: center;">
                            <img src="<?php echo e(asset('images/skeemeword.png')); ?>" width="140" alt="Skeeme" style="display: inline-block; filter: brightness(0.2);">
                        </div>
...
<?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views/layouts/app_email.blade.php ENDPATH**/ ?>