...
<div class="admin-page">
    ...
    <div class="media-grid" id="mediaGrid">
        ...
        <div class="media-item" data-type="<?php echo e($file['type']); ?>" data-name="<?php echo e(strtolower($file['name'])); ?>">
            <div class="media-preview">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($file['type'] === 'image'): ?>
                    <img src="<?php echo e($file['url']); ?>" alt="<?php echo e($file['name']); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                <?php else: ?>
                    <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #60a5fa, #3b82f6); display: flex; align-items: center; justify-content: center; color: white; font-size: 12px;"><?php echo e(strtoupper($file['type'])); ?></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div class="media-overlay">
                    <a href="<?php echo e($file['url']); ?>" class="btn-icon" title="View" target="_blank">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                    </a>
                    <button class="btn-icon" title="Copy URL" onclick="copyToClipboard('<?php echo e($file['url']); ?>')">
                    ...
                    <form action="<?php echo e(route('team.content.media.delete')); ?>" method="POST" style="display:inline;">
                        <?php echo csrf_field(); ?>
            ...
            <div class="media-info">
                <p class="media-name"><?php echo e($file['name']); ?></p>
                <p class="media-meta"><?php echo e(number_format($file['size'] / 1024, 1)); ?> KB • <?php echo e(\Carbon\Carbon::createFromTimestamp($file['uploaded_at'])->format('M d')); ?></p>
            </div>
        </div>
...
<script>
    ...
    function handleFileUpload(event) {
        ...
        for (let file of files) {
            ...
            fetch('<?php echo e(route("team.content.media.upload")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
...
<?php echo $__env->make('team.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\team\content\media\index.blade.php ENDPATH**/ ?>