...
<?php $component->withAttributes(['x-show' => 'showRecoveryCodes','icon' => 'eye-slash','icon:variant' => 'outline','variant' => 'primary','@click' => 'showRecoveryCodes = false','aria-expanded' => 'true','aria-controls' => 'recovery-codes-section']); ?>
                <?php echo e(__('messages.Hide Recovery Codes')); ?>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($recoveryCodes)): ?>
                <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['xShow' => 'showRecoveryCodes','icon' => 'arrow-path','variant' => 'filled','wire:click' => 'regenerateRecoveryCodes','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-show' => 'showRecoveryCodes','icon' => 'arrow-path','variant' => 'filled','wire:click' => 'regenerateRecoveryCodes','wire:loading.attr' => 'disabled']); ?>
                    <span wire:loading.remove><?php echo e(__('messages.Regenerate Codes')); ?></span>
...
<?php $component->withAttributes(['variant' => 'subtle','class' => 'text-xs']); ?>
                        <?php echo e(__('messages.Each recovery code can be used once to access your account and will be removed after use. If you need more, click Regenerate Codes above.')); ?>
...
</div><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\livewire\settings\two-factor\recovery-codes.blade.php ENDPATH**/ ?>