...
<?php endif; ?>
<?php $component->withAttributes(['size' => 'xl','level' => '1']); ?>Attendance History <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Review past attendance records for your courses <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                            ...
                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/40 transition-colors group">
                                ...
                                <td class="p-4">
                                    <div class="flex flex-col">
                                        <div class="text-sm font-bold text-zinc-900 dark:text-zinc-100"><?php echo e($record->course_name); ?></div>
                                        <div class="text-[10px] font-bold text-zinc-500 uppercase tracking-tighter"><?php echo e($record->course_code); ?></div>
                                    </div>
                                </td>
                                <td class="p-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex flex-col">
                                            <div class="text-sm font-bold text-zinc-900 dark:text-zinc-100"><?php echo e($record->student_name ?? 'Unknown Student'); ?></div>
                                            <div class="text-[11px] text-zinc-500 lowercase tracking-tight"><?php echo e($record->student_email ?? ''); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="p-4 text-center">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-widest border
                                        <?php if(strtolower($record->status) === 'present'): ?> bg-emerald-50 text-emerald-700 border-emerald-100 dark:bg-emerald-900/30 dark:text-emerald-400 dark:border-emerald-800
                                        <?php elseif(strtolower($record->status) === 'absent'): ?> bg-rose-50 text-rose-700 border-rose-100 dark:bg-rose-900/30 dark:text-rose-400 dark:border-rose-800
                                        <?php elseif(strtolower($record->status) === 'late'): ?> bg-amber-50 text-amber-700 border-amber-100 dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-800
                                        <?php else: ?> bg-zinc-50 text-zinc-500 border-zinc-100 dark:bg-zinc-800/50 dark:text-zinc-400 dark:border-zinc-700 <?php endif; ?> shadow-sm">
...
</div><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\livewire\lecturer-attendance-history.blade.php ENDPATH**/ ?>