    ...
    <div class="container" style="max-width: 1000px; padding: 0 2rem; margin: 0 auto;">
        ...
        <div class="resource-grid">
            <div class="resource-card" data-aos="zoom-in">
                ...
                <a href="<?php echo e(url('learn/documentation/initial-setup-guide')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Guide →</a>
            </div>
            ...
            <div class="resource-card" data-aos="zoom-in" data-aos-delay="100">
                ...
                <a href="<?php echo e(url('learn/documentation/creating-first-exam')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Guide →</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container" style="max-width: 1000px; padding: 0 2rem; margin: 0 auto;">
        ...
        <div class="resource-grid">
            <div class="resource-card" data-aos="zoom-in">
                ...
                <a href="<?php echo e(url('learn/documentation/exam-management-basics')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Guide →</a>
            </div>
            ...
            <div class="resource-card" data-aos="zoom-in" data-aos-delay="100">
                ...
                <a href="<?php echo e(url('learn/documentation/ai-question-generation')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Guide →</a>
            </div>
            ...
            <div class="resource-card" data-aos="zoom-in" data-aos-delay="200">
                ...
                <a href="<?php echo e(url('learn/documentation/ai-auto-grading')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Guide →</a>
            </div>
            ...
            <div class="resource-card" data-aos="zoom-in" data-aos-delay="300">
                ...
                <a href="<?php echo e(url('learn/documentation/analytics-dashboard')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Guide →</a>
            </div>
            ...
            <div class="resource-card" data-aos="zoom-in" data-aos-delay="400">
                ...
                <a href="<?php echo e(url('learn/documentation/attendance-tracking')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Guide →</a>
            </div>
            ...
            <div class="resource-card" data-aos="zoom-in" data-aos-delay="500">
                ...
                <a href="<?php echo e(url('learn/documentation/generating-reports')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Guide →</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container" style="max-width: 1000px; padding: 0 2rem; margin: 0 auto;">
        ...
        <div class="resource-grid">
            <div class="resource-card" data-aos="zoom-in">
                ...
                <a href="<?php echo e(url('learn/documentation/school-configuration')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Guide →</a>
            </div>
            ...
            <div class="resource-card" data-aos="zoom-in" data-aos-delay="100">
                ...
                <a href="<?php echo e(url('learn/documentation/user-management')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Guide →</a>
            </div>
            ...
            <div class="resource-card" data-aos="zoom-in" data-aos-delay="200">
                ...
                <a href="<?php echo e(url('learn/documentation/data-import-export')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Guide →</a>
            </div>
        </div>
    </div>
</section>
...
<section style="padding: 4rem 0; background: linear-gradient(135deg, rgba(59, 130, 246, 0.1), rgba(139, 92, 246, 0.1));">
    <div class="container" style="max-width: 900px; padding: 0 2rem; margin: 0 auto; text-align: center;">
        ...
        <a href="<?php echo e(url('contact')); ?>" style="padding: 0.75rem 2rem; background: #fff; color: #0A0A0B; border: none; border-radius: 8px; font-weight: 600; text-decoration: none; display: inline-block;">
            Contact Support
        </a>
    </div>
</section>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\landing\learn\documentation.blade.php ENDPATH**/ ?>