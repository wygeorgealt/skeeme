...
<div class="guide-container">
    <div class="breadcrumb" data-aos="fade-down">
        <a href="<?php echo e(url('learn/documentation')); ?>">Documentation</a> / Generating Reports
    </div>
    ...
    <section class="guide-content">
        ...
        <div class="next-section">
            ...
            <p>Learn to configure your school settings and academic structure. Check out our <a href="<?php echo e(url('learn/documentation/school-configuration')); ?>">School Configuration</a> guide.</p>
        </div>
    </section>
</div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\landing\learn\generating-reports.blade.php ENDPATH**/ ?>