...
<body>
    <div class="container">
        ...
        <div class="hero">
            ...
            <p>Your subscription renews in <?php echo e($daysRemaining); ?> days</p>
        </div>

        <div class="content">
            <div class="card">
                <h3>Hello there!</h3>
                <p>Your <?php echo e($planName); ?> plan subscription will automatically renew in <strong><?php echo e($daysRemaining); ?> days</strong>. Here's a summary of what's included.</p>
            </div>
            ...
            <div class="detail-box">
                ...
                <div class="detail-row">
                    ...
                    <strong><?php echo e($renewalAmount); ?></strong>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Renewal Date:</span>
                    <strong><?php echo e($subscription->expires_at->format('M d, Y')); ?></strong>
                </div>
            </div>
            ...
            <div class="button-container">
                <a href="<?php echo e(route('settings.subscription-billing')); ?>" class="button">Manage Subscription</a>
            </div>
...
<?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\emails\subscription-payment-reminder.blade.php ENDPATH**/ ?>