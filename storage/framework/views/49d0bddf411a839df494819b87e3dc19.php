<?php $__env->startSection('hero-label', 'Subscription Upgrade Confirmed'); ?>
<?php $__env->startSection('hero-title', 'You\'re Now an Elite Skeemer! 🚀'); ?>
...
<p style="color:#2c3239; font-family:'Instrument Sans', sans-serif; font-size:19px; font-weight:600; line-height:1.6; text-align:center; margin: 0 0 32px;">
	Hi <?php echo e(explode(' ', $name ?? $user->name ?? 'Student')[0]); ?>, welcome to the top tier! ❤️<br><br>
    Your upgrade to the <strong><?php echo e($planName ?? 'Elite'); ?> Plan</strong> is officially confirmed. You've just unlocked the full power of Skeeme AI to dominate your studies.
</p>
...
<div style="background-color: rgba(139, 92, 246, 0.1); border-radius: 16px; padding: 24px; margin-bottom: 40px; border: 1px dashed #8B5CF6;">
    <p style="color: #ffffff; font-family: 'Instrument Sans', sans-serif; font-size: 14px; text-align: center; margin: 0;">
        Next Billing Date: <strong><?php echo e($nextBillingDate ?? 'Next Month'); ?></strong>
    </p>
</div>
...
<?php echo $__env->make('layouts.app_email', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views/emails/upgrade_confirmation.blade.php ENDPATH**/ ?>