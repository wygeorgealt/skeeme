...
<p style="font-size: 15px; color: #4b5563; line-height: 1.7; margin: 0 0 32px;">
    Hi <?php echo e(explode(' ', $name ?? $user->name ?? 'Student')[0]); ?>, welcome to the top tier! Your upgrade to the <strong style="color: #1a1a1a;"><?php echo e($planName ?? 'Elite'); ?> Plan</strong> unlocks the full power of Skeeme AI.
</p>
...
<div class="card" style="background-color: #F9FAFB; border: 1px solid #F3F4F6; border-radius: 12px; padding: 16px 20px; margin: 0 0 32px; text-align: center;">
    <p style="font-size: 13px; color: #6b7280; margin: 0;">
        Next Billing Date: <strong style="color: #1a1a1a;"><?php echo e($nextBillingDate ?? 'Next Month'); ?></strong>
    </p>
</div>
...
<?php echo $__env->make('layouts.skeeme_email', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views/emails/upgrade_confirmation.blade.php ENDPATH**/ ?>