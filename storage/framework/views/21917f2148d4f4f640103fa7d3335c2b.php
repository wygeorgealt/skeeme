...
<div class="guide-container">
    <div class="breadcrumb" data-aos="fade-down">
        <a href="<?php echo e(url('learn/documentation')); ?>">Documentation</a> / Analytics Dashboard
    </div>
    ...
    <section class="guide-content">
        ...
        <div class="next-section">
            ...
            <p>Learn to track and analyze student attendance. Check out our <a href="<?php echo e(url('learn/documentation/attendance-tracking')); ?>">Attendance Tracking</a> guide.</p>
        </div>
    </section>
</div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\landing\learn\analytics-dashboard.blade.php ENDPATH**/ ?>