        ...
        <div id="general" class="settings-panel active">
            ...
            <form onsubmit="saveSettings(event, 'general')">
                ...
                <div class="form-group">
                    ...
                    <input type="email" value="support@skeeme.com" class="form-input" />
                </div>
...
<style>
    ...
    .settings-container { display: grid; grid-template-columns: 200px 1fr; gap: 20px; }
    
    .settings-nav { display: flex; flex-direction: column; gap: 8px; }
    .nav-item { padding: 12px 16px; background: #1e293b; border: 1px solid #334155; color: #cbd5e1; cursor: pointer; border-radius: 6px; text-align: left; font-size: 12px; font-weight: 500; transition: all 0.3s; }
    .nav-item:hover { border-color: #60a5fa; color: #60a5fa; }
    .nav-item.active { background: #60a5fa; color: white; border-color: #60a5fa; }

    .settings-panel { display: none; background: #1e293b; border: 1px solid #334155; border-radius: 10px; padding: 24px; }
    .settings-panel.active { display: block; }
    .settings-panel h3 { margin: 0 0 20px; font-size: 16px; font-weight: 600; color: #f1f5f9; }
    ...
    .toggle-label { width: 48px; height: 24px; background: #334155; border-radius: 12px; cursor: pointer; position: relative; transition: all 0.3s; }
    .toggle-label::after { content: ''; position: absolute; width: 20px; height: 20px; background: white; border-radius: 50%; top: 2px; left: 2px; transition: all 0.3s; }
    input[type="checkbox"]:checked + .toggle-label { background: #60a5fa; }
    input[type="checkbox"]:checked + .toggle-label::after { left: 26px; }
    .toggle-text { font-size: 11px; color: #94a3b8; }

    .features-list { display: grid; gap: 16px; }
    .feature-item { display: flex; justify-content: space-between; align-items: center; padding: 16px; background: #0f172a; border: 1px solid #334155; border-radius: 8px; }
    .feature-info h4 { margin: 0 0 4px; font-size: 13px; font-weight: 600; color: #f1f5f9; }
    .feature-info p { margin: 0; font-size: 11px; color: #94a3b8; }

    .btn { padding: 8px 16px; border-radius: 6px; border: none; cursor: pointer; font-size: 12px; font-weight: 500; transition: all 0.3s; }
    ...
    @media (max-width: 768px) {
        ...
        .nav-item { flex: 1; min-width: 100px; }
    }
</style>
...
<?php echo $__env->make('team.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\team\settings\system\index.blade.php ENDPATH**/ ?>