<?php $__env->startSection('hero-label', 'Welcome to the Future'); ?>
<?php $__env->startSection('hero-title', 'Welcome to Skeeme!'); ?>
<?php $__env->startSection('hero-subtitle', 'Your AI journey starts now'); ?>
...
<p style="color:#2c3239; font-family:'Instrument Sans', sans-serif; font-size:19px; font-weight:600; line-height:1.6; text-align:center; margin: 0 0 32px;">
	Hi <?php echo e(explode(' ', $name ?? $user->name ?? 'Student')[0]); ?>, welcome to the family! ❤️<br><br>
...
<?php echo $__env->make('layouts.app_email', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views/emails/welcome.blade.php ENDPATH**/ ?>