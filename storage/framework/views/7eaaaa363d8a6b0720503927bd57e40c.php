    ...
    <div class="grid lg:grid-cols-5 gap-8 items-start mb-24">
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="p-6 rounded-3xl bg-white border border-slate-100 shadow-xl shadow-indigo-100/50">
                ...
                <!-- Inputs -->
                <div class="space-y-4" x-data="{ inputMode: <?php echo \Illuminate\Support\Js::from($file ? 'file' : ($topic ? 'topic' : 'none'))->toHtml() ?> }"
                     x-init="
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['wire:model.live.debounce.300ms' => 'topic','placeholder' => 'e.g. Photosynthesis, World War II...','class' => '!bg-slate-50 !border-slate-200','xBind:class' => 'inputMode === \'file\' && \'!opacity-50 !pointer-events-none\'','xBind:disabled' => 'inputMode === \'file\'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live.debounce.300ms' => 'topic','placeholder' => 'e.g. Photosynthesis, World War II...','class' => '!bg-slate-50 !border-slate-200','x-bind:class' => 'inputMode === \'file\' && \'!opacity-50 !pointer-events-none\'','x-bind:disabled' => 'inputMode === \'file\'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['wire:click' => 'generate','@click' => 'resultsVisible = true','variant' => 'primary','class' => 'w-full !rounded-xl !py-4 font-bold shadow-lg shadow-indigo-500/20','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'generate','@click' => 'resultsVisible = true','variant' => 'primary','class' => 'w-full !rounded-xl !py-4 font-bold shadow-lg shadow-indigo-500/20','wire:loading.attr' => 'disabled']); ?>
...
<?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views/livewire/landing/student-ai-generator.blade.php ENDPATH**/ ?>