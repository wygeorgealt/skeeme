        ...
        <div class="content">
            ...
            <div class="invoice-box">
                ...
                <table>
                    ...
                    <tr>
                        <td><strong><?php echo e($invoiceNumber); ?></strong></td>
                        <td><strong><?php echo e($dueDate); ?></strong></td>
                    </tr>
                </table>
                ...
                <table>
                    ...
                    <tr>
                        <td><?php echo e($invoice->plan_name ?? 'Subscription Plan'); ?></td>
            ...
            <div class="button-container">
                <a href="<?php echo e(route('invoices.view', ['invoice' => $invoice->id])); ?>" class="button">View Invoice</a>
            </div>
...
<?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\emails\invoice-generated.blade.php ENDPATH**/ ?>