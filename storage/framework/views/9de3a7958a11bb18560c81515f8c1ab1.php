            ...
            <div data-aos="fade-right" data-aos-duration="800">
                ...
                <ul class="space-y-4 mb-10 max-w-md">
                    <li class="flex items-start gap-3">
                        <div class="mt-1 bg-indigo-100 p-1 rounded-full"><?php if (isset($component)) { $__componentOriginal1b4a7fc77dda99afab79e49ee452ebcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1b4a7fc77dda99afab79e49ee452ebcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.camera','data' => ['class' => 'size-4 text-indigo-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-4 text-indigo-600']); ?>
...
<?php endif; ?></div>
                    ...
                    <li class="flex items-start gap-3">
                        <div class="mt-1 bg-indigo-100 p-1 rounded-full"><?php if (isset($component)) { $__componentOriginal74697c151ccb8418c53b50a995b31225 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal74697c151ccb8418c53b50a995b31225 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.document-text','data' => ['class' => 'size-4 text-indigo-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?></div>
                    ...
                    <li class="flex items-start gap-3">
                        <div class="mt-1 bg-indigo-100 p-1 rounded-full"><?php if (isset($component)) { $__componentOriginale0a0c12575af25a71f941c8515365d96 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale0a0c12575af25a71f941c8515365d96 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.bolt','data' => ['class' => 'size-4 text-indigo-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?></div>
            ...
            <div class="relative lg:h-[700px] flex justify-center items-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                ...
                <div class="relative z-10 w-full max-w-md mx-auto hover:-translate-y-2 transition-transform duration-700">
                    <img src="<?php echo e(asset('images/student_app_mockup.png')); ?>" class="w-full h-auto drop-shadow-2xl rounded-[2rem]" alt="Skeeme App Screenshot" />
                </div>
                ...
                <div class="absolute -left-6 lg:-left-12 top-1/4 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 z-20 animate-bounce" style="animation-duration: 3s;">
                    <div class="flex items-center gap-3">
                        <div class="bg-green-100 bg-opacity-50 p-2 rounded-full"><?php if (isset($component)) { $__componentOriginal99e1287553cbf55f278732425b3f00bd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal99e1287553cbf55f278732425b3f00bd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.check-circle','data' => ['class' => 'size-5 text-green-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
