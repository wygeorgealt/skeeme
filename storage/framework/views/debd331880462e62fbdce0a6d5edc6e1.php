...
<div style="margin-top: 40px;">
    <a href="<?php echo e(config('app.url')); ?>/dashboard" class="btn">Explore Dashboard</a>
</div>

<p style="margin-top: 48px; font-size: 14px; color: #94A3B8;">
    Need help getting started? Check out our <a href="<?php echo e(config('app.url')); ?>/guide" style="color: #6366F1; text-decoration: none;">Getting Started Guide</a> or reply to this email!
</p>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.email_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views/emails/welcome_v2.blade.php ENDPATH**/ ?>