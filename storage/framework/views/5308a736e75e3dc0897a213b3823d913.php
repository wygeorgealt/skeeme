...
<div class="guide-container">
    <div class="breadcrumb" data-aos="fade-down">
        <a href="<?php echo e(url('learn/documentation')); ?>">Documentation</a> / Creating Your First Exam
    </div>
    ...
    <section class="guide-content">
        ...
        <div class="section" data-aos="fade-up">
            ...
            <ul class="feature-list">
                <li><a href="<?php echo e(url('learn/documentation/exam-management-basics')); ?>" style="color: #3b82f6;">Exam Management Basics</a> - Learn more advanced exam features</li>
                <li><a href="<?php echo e(url('learn/documentation/ai-question-generation')); ?>" style="color: #3b82f6;">AI Question Generation</a> - Use AI to create questions faster</li>
                <li><a href="<?php echo e(url('learn/documentation/ai-auto-grading')); ?>" style="color: #3b82f6;">AI Auto-Grading</a> - Let AI help with essay grading</li>
                <li><a href="<?php echo e(url('learn/documentation/analytics-dashboard')); ?>" style="color: #3b82f6;">Analytics Dashboard</a> - Analyze exam results</li>
            </ul>

            <div class="next-section">
                <h3 style="margin-top: 0;">Want to dive deeper?</h3>
                <p>Learn more about advanced exam features in our <a href="<?php echo e(url('learn/documentation/exam-management-basics')); ?>">Exam Management Basics</a> guide.</p>
            </div>
        </div>
    </section>
</div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\landing\learn\creating-first-exam.blade.php ENDPATH**/ ?>