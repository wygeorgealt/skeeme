...
<div class="admin-page">
    ...
    <div class="kpi-grid">
        <div class="kpi-card">
            ...
            <div class="kpi-value"><?php echo e(number_format($signups)); ?></div>
            <div class="kpi-change <?php echo e($signupChange >= 0 ? 'positive' : 'negative'); ?>"><?php echo e($signupChange >= 0 ? '↑' : '↓'); ?> <?php echo e(abs($signupChange)); ?>% from last period</div>
        </div>
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-value"><?php echo e(number_format($activeUsers)); ?></div>
            <div class="kpi-change positive">↑ <?php echo e($activeUsersChange); ?>% from last period</div>
        </div>
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-value"><?php echo e(number_format($conversionRate, 1)); ?>%</div>
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-change <?php echo e($revenueChange >= 0 ? 'positive' : 'negative'); ?>"><?php echo e($revenueChange >= 0 ? '↑' : '↓'); ?> <?php echo e(abs($revenueChange)); ?>% from last period</div>
        </div>
    </div>
...
<?php echo $__env->make('team.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\team\analytics\dashboard.blade.php ENDPATH**/ ?>