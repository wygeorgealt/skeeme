                                ...
                                <div class="flex items-center justify-between p-4 bg-zinc-50 dark:bg-zinc-800/30 rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-800/50 transition-colors border border-zinc-100 dark:border-zinc-800/50">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[10px] font-bold text-zinc-400 uppercase tracking-tighter"><?php echo e($course->code); ?></p>
                                        </div>
                                    </div>
                                    <div class="flex flex-col items-end gap-1">
                                        <div class="text-[10px] font-bold text-zinc-900 dark:text-zinc-100"><?php echo e(($course->completed_topics / max(1, $course->total_topics)) * 100); ?>%</div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'ghost','size' => 'sm','class' => 'text-[10px] uppercase tracking-wider font-bold']); ?>View All <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580)): ?>
<?php $attributes = $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580; ?>
<?php unset($__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580); ?>
