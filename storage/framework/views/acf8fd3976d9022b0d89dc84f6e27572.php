...
<div class="admin-page">
    <div class="page-header">
        ...
        <p class="page-subtitle">Enable or disable system features</p>
    </div>
    <div class="content-section">
        <p>Feature under construction - Full functionality coming soon</p>
        <a href="<?php echo e(route('team.dashboard')); ?>" class="btn btn-secondary">Back to Dashboard</a>
    </div>
</div>
...
<?php echo $__env->make('team.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\team\settings\features\index.blade.php ENDPATH**/ ?>