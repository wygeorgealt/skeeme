...
<style>
    ...
    .code-block { background: rgba(0, 0, 0, 0.3); border: 1px solid rgba(255, 255, 255, 0.1); padding: 1rem; border-radius: 8px; overflow-x: auto; margin: 1rem 0; font-family: 'Courier New', monospace; }
...
<div class="guide-container">
    <div class="breadcrumb" data-aos="fade-down">
        <a href="<?php echo e(url('learn/documentation')); ?>">Documentation</a> / Initial Setup Guide
    </div>

    <section class="guide-hero" data-aos="fade-up">
        <h1>Initial Setup Guide</h1>
        <p>Get your Skeeme account up and running in minutes. This comprehensive guide walks you through account creation, school configuration, and user onboarding.</p>
        <p style="color: #9ca3af; font-size: 0.95rem;">⏱️ Estimated reading time: 12 minutes</p>
    </section>
    ...
    <section class="guide-content">
        ...
        <div class="section" data-aos="fade-up">
            <h2>Overview</h2>
            <p>Skeeme is a comprehensive educational management and assessment platform designed to streamline school operations and enhance learning outcomes. Before you can start creating exams, managing students, and leveraging AI-powered features, you need to set up your school environment.</p>
        ...
        <div class="section" data-aos="fade-up">
            ...
            <div class="step-box">
                ...
                <p><strong>Email Address:</strong> Use your school's official email address (e.g., admin@yourschool.edu) for better credibility and recovery options.</p>
                <p><strong>Full Name:</strong> Enter your complete legal name for verification purposes.</p>
                <p><strong>Password:</strong> Create a strong password with at least 12 characters including uppercase, lowercase, numbers, and symbols.</p>
                <p><strong>Role:</strong> Select "School Administrator" to access all administrative features.</p>
            </div>

            <div class="tip-box">
                <strong>💡 Pro Tip:</strong> Consider using a dedicated administrator email address that can be accessed by multiple team members. This ensures continuity if the original administrator leaves.
            </div>

            <p>After completing the registration form, you'll receive a verification email. Click the verification link within 24 hours to activate your account.</p>

            <h3>Email Verification</h3>
            <p>Check your inbox for a verification email from Skeeme. If you don't see it within 5 minutes, check your spam folder. The verification link is valid for 24 hours.</p>
        </div>
        ...
        <div class="section" data-aos="fade-up">
            ...
            <p>Once logged in, you'll be guided through the School Profile Setup wizard. This is where you define your school's identity in Skeeme.</p>

            <div class="step-box">
                <h4>📍 Essential Information</h4>
                <p><strong>School Name:</strong> The official name of your school as it should appear throughout the system.</p>
                <p><strong>School Code:</strong> A unique identifier for your school (typically 4-6 characters). This is used for integrations and API access.</p>
                <p><strong>Address:</strong> Your school's physical address (used for official documents and communications).</p>
                <p><strong>Country & Region:</strong> Your school's location (this affects timezone settings and locale options).</p>
        ...
        <div class="section" data-aos="fade-up">
            ...
            <p>Define the academic year structure for your school. This affects scheduling, grade reporting, and exam periods.</p>
            ...
            <p>You can have multiple academic years configured simultaneously, making it easy to transition between years.</p>
            ...
            <div class="step-box">
                <h4>🏫 Class Setup</h4>
                <p><strong>Classes/Grades:</strong> Create classes like "Form 1A," "Senior 2B," or "Grade 9 Advanced"</p>
                <p><strong>Departments:</strong> Organize by subject (Math, English, Science) or organizational unit (Primary, Secondary)</p>
                <p><strong>Sections:</strong> Further subdivide classes if needed (e.g., Section A, Section B)</p>
            </div>

            <div class="tip-box">
                <strong>💡 Pro Tip:</strong> Create your full academic structure before inviting teachers and students. This makes the onboarding process smoother and ensures everyone is organized from day one.
            </div>
        </div>
        ...
        <div class="section" data-aos="fade-up">
            ...
            <p>For larger schools, you might want additional administrators to help manage the system. Add trusted staff members as administrators.</p>

            <div class="step-box">
                <h4>👥 Adding Administrators</h4>
                <p>Navigate to: Admin Dashboard → User Management → Add Administrator</p>
                <p>Fill in the administrator's details and select their permission level (see section below for permission types).</p>
            </div>
            ...
            <div class="warning-box">
                <strong>⚠️ Important:</strong> Only grant Super Admin access to trusted, senior staff members. Use specific role-based permissions for others.
            </div>
        </div>
        ...
        <div class="section" data-aos="fade-up">
            ...
            <p>Teachers are the backbone of your Skeeme implementation. You can invite them individually or in bulk via CSV.</p>

            <h3>Individual Invitation</h3>
            <div class="step-box">
                <h4>👨‍🏫 Inviting a Single Teacher</h4>
                <p><strong>Step 1:</strong> Go to Admin Dashboard → User Management → Invite Teachers</p>
...
jane.smith@school.edu,Jane Smith,T002,English,"Form 1A, Form 1B"</div>
            ...
            <p>Upload the CSV file via Admin Dashboard → User Management → Bulk Upload Teachers. The system will validate and send invitations automatically.</p>
        </div>
        ...
        <div class="section" data-aos="fade-up">
            ...
            <div class="tip-box">
                <strong>💡 Pro Tip:</strong> Enable two-factor authentication for all administrators from day one. This adds an extra layer of security to sensitive operations.
            </div>
        ...
        <div class="section" data-aos="fade-up">
            ...
            <div class="step-box">
                ...
                <p>□ School profile is complete and accurate</p>
                <p>□ Academic calendar is set for the current academic year</p>
                <p>□ Classes and departments are created</p>
                <p>□ At least one administrator account is configured</p>
                <p>□ Teachers have been invited (even just one for testing)</p>
                <p>□ Email notifications are properly configured</p>
                <p>□ Security settings are enabled</p>
                <p>□ You can log in and access the admin dashboard</p>
            </div>

            <h3>Testing Your Setup</h3>
            <p>Create a test account to ensure everything works smoothly. Invite one teacher and check that they receive the invitation email and can set up their account.</p>

            <div class="tip-box">
                <strong>💡 Pro Tip:</strong> Set aside a "test class" where you can experiment with features before rolling out to the entire school.
            </div>
        </div>
        ...
        <div class="section" data-aos="fade-up">
            ...
            <p><strong>Solution:</strong> Check spam/junk folders. If still not found, request a new verification email from the login page. Ensure you're using the correct email address.</p>

            <h3>Can't Access Admin Dashboard</h3>
            <p><strong>Solution:</strong> Ensure your account has been verified. If verified but still locked out, contact support with your email address and school name.</p>

            <h3>Teachers Not Receiving Invitations</h3>
            <p><strong>Solution:</strong> Verify the teacher's email address is correct. Check the "Sent Invitations" log in User Management. Resend invitation if needed. Ensure your school's email isn't being blocked by the teacher's email provider.</p>

            <h3>Academic Calendar Issues</h3>
            <p><strong>Solution:</strong> Ensure the academic year start date is before the end date. Check that term dates don't overlap. Contact support if you need to modify past academic years.</p>
        </div>
        ...
        <div class="section" data-aos="fade-up">
            ...
            <div class="next-section">
                ...
                <p>Head over to the <a href="<?php echo e(url('learn/documentation/inviting-users')); ?>">Inviting Users</a> guide to start building your school community.</p>
            </div>
        </div>
        ...
        <div class="section" data-aos="fade-up">
            ...
            <ul class="feature-list">
                <li>Check our <a href="<?php echo e(url('learn/documentation')); ?>" style="color: #3b82f6;">full documentation</a> for detailed articles</li>
                <li>Email our support team: <strong>support@skeeme.com</strong></li>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\landing\learn\initial-setup-guide.blade.php ENDPATH**/ ?>