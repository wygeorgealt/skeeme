<div class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4 md:p-8">
    ...
    <!-- Statistics Cards -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($examReport)): ?>
            ...
            <div class="bg-slate-700/50 backdrop-blur rounded-lg p-6 border border-slate-600">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white mt-2"><?php echo e($examReport['total_checks'] ?? 0); ?></p>
                    </div>
            ...
            <div class="bg-slate-700/50 backdrop-blur rounded-lg p-6 border border-slate-600">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-red-400 mt-2"><?php echo e($examReport['flagged_count'] ?? 0); ?></p>
                        <p class="text-xs text-slate-500 mt-1">
                            <?php echo e(number_format($examReport['flagged_percentage'] ?? 0, 1)); ?>%
                        </p>
                    </div>
                    <div class="text-4xl opacity-20">🚨</div>
                </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white mt-2">
                            <?php echo e(number_format(($examReport['average_score'] ?? 0) * 100, 0)); ?>%
                        </p>
                    </div>
                    <div class="text-4xl opacity-20">📈</div>
                </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-red-400 mt-2">
                            <?php echo e(number_format(($examReport['highest_score'] ?? 0) * 100, 0)); ?>%
                        </p>
                    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($examReport['by_severity'])): ?>
        <div class="max-w-7xl mx-auto mb-8">
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-slate-700/30 backdrop-blur rounded-lg border border-slate-600 overflow-hidden">
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            <button 
                                ...
                                "
                            >
                                All Checks (<?php echo e(count($filteredChecks)); ?>)
                            </button>
                            <button 
                                wire:click="toggleFilter('flagged')"
                                class="w-full px-3 py-2 rounded text-sm transition text-left
                                    <?php if($filterStatus === 'flagged'): ?>
                                ...
                                "
                            >
                                Flagged (<?php echo e($examReport['flagged_count'] ?? 0); ?>)
                            </button>
                            <button 
                                wire:click="toggleFilter('clean')"
                                class="w-full px-3 py-2 rounded text-sm transition text-left
                                    <?php if($filterStatus === 'clean'): ?>
                ...
                <div class="overflow-y-auto max-h-96">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($filteredChecks)): ?>
                        <div class="p-4 text-center text-slate-400 text-sm">
                            <p>No plagiarism checks available.</p>
                            <p class="text-xs mt-2">Run checks to analyze answers.</p>
                        </div>
                    <?php else: ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $filteredChecks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $check): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button 
                                wire:click="selectCheck('<?php echo e($check['id']); ?>')"
                                class="w-full text-left px-4 py-3 border-b border-slate-600 transition
                                    <?php if($selectedCheckId === (string) $check['id']): ?>
                                ...
                                <div class="flex items-start justify-between gap-2">
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-2">
                                            <span class="text-lg">
                                                <?php echo e($this->getSeverityIcon($check['severity'])); ?>

                                            </span>
                                            <p class="text-sm font-medium text-slate-100 truncate">
                                                Q<?php echo e($check['question_id']); ?>

                                            </p>
                                        </div>
                                        <p class="text-xs text-slate-500 mt-1 line-clamp-2">
                                            <?php echo e($check['session']); ?>

                                        </p>
                                    </div>
                                    <div class="text-right flex-shrink-0">
                                        <p class="text-sm font-bold text-white">
                                            <?php echo e(number_format($check['plagiarism_score'] * 100, 0)); ?>%
                                        </p>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($check['flagged_at']): ?>
        ...
        <div class="lg:col-span-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedCheck): ?>
                <div class="bg-slate-700/30 backdrop-blur rounded-lg border border-slate-600 p-6 space-y-6">
                        ...
                        <div class="flex items-start justify-between gap-4 mb-4">
                            <div class="flex-1">
                                ...
                                <p class="text-slate-300 text-sm">
                                    <?php echo e($selectedCheck['question_text']); ?>

                                </p>
                            </div>
                            <div class="text-right">
                                <span class="inline-block px-3 py-1 rounded <?php echo e($this->getSeverityColor($selectedCheck['severity'])); ?> font-bold">
                                    <?php echo e($selectedCheck['severity_label']); ?>
                            ...
                            <div class="flex-1">
                                <div class="relative h-3 bg-slate-600/30 rounded-full overflow-hidden">
                                    <div 
                                        ...
                                        style="width: <?php echo e($selectedCheck['plagiarism_score'] * 100); ?>%;
                                                background: <?php if($selectedCheck['plagiarism_score'] >= 0.8): ?> rgb(239, 68, 68) <?php elseif($selectedCheck['plagiarism_score'] >= 0.6): ?> rgb(249, 115, 22) <?php elseif($selectedCheck['plagiarism_score'] >= 0.4): ?> rgb(234, 179, 8) <?php else: ?> rgb(59, 130, 246) <?php endif; ?>"
                                    ></div>
                                </div>
                            </div>
                            <div class="text-right min-w-fit">
                                <p class="text-2xl font-bold text-white">
                                    <?php echo e(number_format($selectedCheck['plagiarism_score'] * 100, 1)); ?>%
                                </p>
                            </div>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedCheck['checked_at']): ?>
                            <p class="text-xs text-slate-500 mt-2">
                                Checked: <?php echo e($selectedCheck['checked_at']); ?>
                    ...
                    <div>
                        ...
                        <div class="bg-slate-800/50 rounded-lg p-4 border border-slate-600 max-h-48 overflow-y-auto">
                            <p class="text-slate-300 text-sm whitespace-pre-wrap">
                                <?php echo e($selectedCheck['student_answer']); ?>
                    ...
                    <!-- Status and Actions -->
                    <div class="flex gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedCheck['flagged_at']): ?>
                            <div class="flex-1 bg-red-600/20 border-l-4 border-l-red-600 rounded-lg p-4">
                                ...
                                <p class="text-red-400 text-xs mt-1">
                                    Flagged at: <?php echo e($selectedCheck['flagged_at']); ?>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <label class="flex items-center">
                            ...
                            >
                            <span class="ml-2 text-slate-400 text-sm"><?php echo e($plagiarism_check_enabled ? 'Enabled' : 'Disabled'); ?></span>
                        </label>
                    </div>
                    ...
                    <div>
                        <label class="block text-slate-300 font-medium mb-2">
                            Plagiarism Threshold: <?php echo e(number_format($plagiarism_threshold * 100, 0)); ?>%
                        </label>
                        <input 
                            type="range" 
                            min="0.1" 
                    ...
                    <!-- Penalty Marks -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($penalty_for_flagged === 'mark_deduction'): ?>
                        <div>
...
</div><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\livewire\plagiarism-manager.blade.php ENDPATH**/ ?>