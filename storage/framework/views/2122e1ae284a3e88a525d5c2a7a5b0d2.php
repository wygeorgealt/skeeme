...
<head>
    ...
    <title><?php echo e($title ?? 'Skeeme'); ?></title>
    <!--[if !mso]><!-->
                ...
                <table class="email-container" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%; margin: 0 auto; background-color: #ffffff; border-radius: 0;">
                    ...
                    <tr>
                        <td align="center" style="padding: 40px 48px 32px;">
                            <img src="<?php echo e(config('app.url')); ?>/images/logo.png" alt="Skeeme" width="120" style="display: block; filter: brightness(0);">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 16px 48px 40px;">
                            <img src="<?php echo e(config('app.url')); ?>/images/logo.png" alt="Skeeme" width="28" style="display: block; filter: brightness(0); opacity: 0.3;">
                        </td>
                    </tr>
...
<?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views/layouts/skeeme_email.blade.php ENDPATH**/ ?>