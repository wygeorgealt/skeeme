    ...
    <div class="metrics-row">
        <div class="metric-card">
            ...
            <div class="metric-content">
                ...
                <div class="metric-value">$<?php echo e(number_format($revenue_this_month, 0)); ?></div>
                <div class="metric-detail">+<?php echo e(round((($revenue_this_month - $revenue_last_month) / $revenue_last_month * 100), 1)); ?>% vs last month</div>
            </div>
        </div>
        <div class="metric-card">
            ...
            <div class="metric-content">
                ...
                <div class="metric-value">$<?php echo e(number_format($total_refunds, 0)); ?></div>
                <div class="metric-detail"><?php echo e(round(($total_refunds / $revenue_this_month * 100), 2)); ?>% of revenue</div>
            </div>
        </div>
        <div class="metric-card">
            ...
            <div class="metric-content">
                ...
                <div class="metric-value"><?php echo e($pending_invoices); ?></div>
        ...
        <div class="metric-card">
            ...
            <div class="metric-content">
                ...
                <div class="metric-value"><?php echo e($failed_payments); ?></div>
...
<?php echo $__env->make('team.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\team\financial\dashboard.blade.php ENDPATH**/ ?>