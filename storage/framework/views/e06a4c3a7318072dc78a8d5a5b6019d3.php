...
<?php endif; ?>
                ...
                <div class="mt-5 space-x-0.5 text-sm leading-5 text-center">
                    <span class="opacity-50"><?php echo e(__('messages.or you can')); ?></span>
                    <div class="inline font-medium underline cursor-pointer opacity-80">
                        <span x-show="!showRecoveryInput" @click="toggleInput()"><?php echo e(__('messages.login using a recovery code')); ?></span>
                        <span x-show="showRecoveryInput" @click="toggleInput()"><?php echo e(__('messages.login using an authentication code')); ?></span>
                    </div>
                </div>
            </form>
        </div>
...
<?php endif; ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\livewire\auth\two-factor-challenge.blade.php ENDPATH**/ ?>