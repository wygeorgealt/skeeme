...
<?php endif; ?>
    ...
    <div class="flex gap-1 bg-zinc-100 dark:bg-zinc-800/50 p-1 rounded-xl w-fit mb-8 border border-zinc-200 dark:border-zinc-800 relative">
        <button 
            ...
            class="flex items-center gap-2 px-6 py-2.5 rounded-lg text-xs font-bold uppercase tracking-widest transition-all <?php echo e($activeTab === 'upcoming' ? 'bg-white dark:bg-zinc-800 text-indigo-600 shadow-sm border border-zinc-200 dark:border-zinc-700' : 'text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300'); ?>"
        >
            <i class="fas fa-calendar-alt"></i>
            Upcoming
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($upcomingExams) > 0): ?>
                <span class="ml-1 px-1.5 py-0.5 bg-indigo-500 text-white rounded text-[10px]"><?php echo e(count($upcomingExams)); ?></span>
    ...
    <div class="max-w-7xl mx-auto relative min-h-[400px]">
        ...
        <!-- Upcoming Exams Tab -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'upcoming'): ?>
            <div class="space-y-6 animate-fadeIn">
                ...
                <?php else: ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-fadeIn">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $upcomingExams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden flex flex-col group hover:shadow-md transition-shadow">
                                <div class="p-6 flex-1">
                                    ...
                                    <h3 class="text-sm font-bold text-zinc-900 dark:text-zinc-100 mb-1 group-hover:text-indigo-500 transition-colors uppercase tracking-tight"><?php echo e($exam['title']); ?></h3>
                                    ...
                                    <div class="grid grid-cols-2 gap-4 mb-6">
                                        <div class="bg-zinc-50 dark:bg-zinc-800/50 p-3 rounded-xl border border-zinc-100 dark:border-zinc-800">
                                            ...
                                            <p class="text-xs font-bold text-zinc-700 dark:text-zinc-200"><?php echo e($exam['exam_date']?->format('d M, Y')); ?></p>
                                            <p class="text-[10px] font-medium text-zinc-500"><?php echo e($exam['exam_date']?->format('H:i')); ?></p>
                                        </div>
                                        <div class="bg-zinc-50 dark:bg-zinc-800/50 p-3 rounded-xl border border-zinc-100 dark:border-zinc-800">
                                            <p class="text-[9px] font-bold text-zinc-400 uppercase tracking-tighter mb-1">Duration</p>
                                            <p class="text-xs font-bold text-zinc-700 dark:text-zinc-200"><?php echo e($exam['duration']); ?> Mins</p>
                                            <p class="text-[10px] font-medium text-zinc-500"><?php echo e($exam['total_marks']); ?> Marks</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-2 mb-6">
                                        <div class="w-6 h-6 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-[10px] font-bold text-zinc-500">
                                            <?php echo e(strtoupper(substr($exam['lecturer'] ?? 'U', 0, 1))); ?>

                                        </div>
                                        <span class="text-[10px] font-bold text-zinc-600 dark:text-zinc-400"><?php echo e($exam['lecturer'] ?? 'Unassigned'); ?></span>
                                    </div>
                                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['wire:click' => 'startExam('.e($exam['id']).')','variant' => 'primary','class' => 'flex-1 text-[10px] font-bold uppercase tracking-widest']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'startExam('.e($exam['id']).')','variant' => 'primary','class' => 'flex-1 text-[10px] font-bold uppercase tracking-widest']); ?>Start Exam <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['wire:click' => 'showExamDetails('.e($exam['session'] ?? 'null').')','variant' => 'ghost','icon' => 'eye','class' => 'text-[10px] font-bold uppercase tracking-widest']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'showExamDetails('.e($exam['session'] ?? 'null').')','variant' => 'ghost','icon' => 'eye','class' => 'text-[10px] font-bold uppercase tracking-widest']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580)): ?>
<?php $attributes = $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580; ?>
<?php unset($__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'resumeExam('.e($exam['session']?->id ?? 'null').')','variant' => 'primary','color' => 'orange','class' => 'w-full text-xs font-bold uppercase tracking-[0.2em] py-4']); ?>Continue Exam Session <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580)): ?>
<?php $attributes = $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580; ?>
<?php unset($__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580); ?>
