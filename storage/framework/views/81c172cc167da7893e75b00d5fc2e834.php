    ...
    <div class="container" style="max-width: 1400px; padding: 0 2rem;">
        ...
        <div style="background: rgba(51, 65, 85, 0.3); padding: 4rem 2rem; border-radius: 12px; border: 2px dashed rgba(255, 255, 255, 0.1); text-align: center;">
            ...
            <p style="color: #9ca3af; margin-bottom: 2rem;">
                In the meantime, check out our <a href="<?php echo e(url('/learn/documentation')); ?>" style="color: #3b82f6; text-decoration: none;">documentation</a> and <a href="<?php echo e(url('/learn/blog')); ?>" style="color: #3b82f6; text-decoration: none;">blog</a> for helpful guides.
            </p>
            <a href="<?php echo e(url('contact')); ?>" style="padding: 0.75rem 2rem; background: #3b82f6; color: #fff; border: none; border-radius: 8px; font-weight: 600; text-decoration: none; display: inline-block;">
...
<section style="padding: 4rem 0;">
    <div class="container" style="max-width: 1200px; padding: 0 2rem; text-align: center;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem;">
            <a href="<?php echo e(url('/learn/blog')); ?>" style="text-decoration: none;">
            ...
            <a href="<?php echo e(url('/learn/community')); ?>" style="text-decoration: none;">
                <div style="background: rgba(51, 65, 85, 0.3); padding: 2rem; border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.1); transition: all 0.2s ease;">
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views/landing/learn/tutorials.blade.php ENDPATH**/ ?>