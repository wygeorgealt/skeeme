    ...
    <div class="container" style="max-width: 1000px; padding: 0 2rem; margin: 0 auto;">
        ...
        <div class="blog-grid">
            <div class="blog-card" data-aos="zoom-in">
                ...
                <a href="<?php echo e(route('learn.blog.ai-powered-education')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Article →</a>
            </div>
            ...
            <div class="blog-card" data-aos="zoom-in" data-aos-delay="100">
                ...
                <a href="<?php echo e(route('learn.blog.analytics-improve-outcomes')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Article →</a>
            </div>
            ...
            <div class="blog-card" data-aos="zoom-in" data-aos-delay="200">
                ...
                <a href="<?php echo e(route('learn.blog.new-analytics-dashboard')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Article →</a>
            </div>
            ...
            <div class="blog-card" data-aos="zoom-in" data-aos-delay="300">
                ...
                <a href="<?php echo e(route('learn.blog.lagos-secondary-case-study')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Article →</a>
            </div>
            ...
            <div class="blog-card" data-aos="zoom-in" data-aos-delay="400">
                ...
                <a href="<?php echo e(route('learn.blog.exam-security-preventing-cheating')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Article →</a>
            </div>
            ...
            <div class="blog-card" data-aos="zoom-in" data-aos-delay="500">
                ...
                <a href="<?php echo e(route('learn.blog.creating-effective-online-exams')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Read Article →</a>
            </div>
        </div>
    </div>
</section>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\landing\learn\blog.blade.php ENDPATH**/ ?>