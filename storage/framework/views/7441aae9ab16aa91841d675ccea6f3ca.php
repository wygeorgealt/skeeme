             ...
             <div class="flex flex-col lg:flex-row items-center gap-24">
                ...
                <div class="flex-1" data-aos="zoom-in">
                    <div class="premium-card p-2 relative group rotate-2">
                        <img src="<?php echo e(asset('landing/dashboard.svg')); ?>" alt="Dashboard Preview" class="w-full h-auto rounded-3xl relative z-10 shadow-2xl">
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views/landing/features/dashboard.blade.php ENDPATH**/ ?>