...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['wire:click' => 'refreshAnalytics','variant' => 'filled','size' => 'sm','class' => '!bg-indigo-600 hover:!bg-indigo-700']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'refreshAnalytics','variant' => 'filled','size' => 'sm','class' => '!bg-indigo-600 hover:!bg-indigo-700']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.arrow-path','data' => ['class' => 'mr-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginal5027d420cfeeb03dd925cfc08ae44851 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5027d420cfeeb03dd925cfc08ae44851 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::menu.item','data' => ['icon' => 'printer']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::menu.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'printer']); ?>Print Summary <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5027d420cfeeb03dd925cfc08ae44851)): ?>
<?php $attributes = $__attributesOriginal5027d420cfeeb03dd925cfc08ae44851; ?>
<?php unset($__attributesOriginal5027d420cfeeb03dd925cfc08ae44851); ?>
...
<?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($insights['topic_recommendations'])): ?>
                        <div class="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden mb-8 animate-fadeIn">
                            <div class="px-8 py-6 border-b border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-800/20">
                            ...
                            <div class="p-8">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $insights['topic_recommendations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-start gap-5 p-5 rounded-2xl bg-zinc-50/50 dark:bg-zinc-800/10 border border-zinc-100 dark:border-zinc-800 border-l-4 <?php echo e($rec['priority'] === 'high' ? '!border-l-rose-500' : '!border-l-amber-500'); ?>">
                                            <div class="flex-1">
                                                <div class="flex items-center gap-2 mb-2">
                                                    <span class="text-[10px] font-black uppercase tracking-widest text-zinc-500"><?php echo e(str_replace('_', ' ', $rec['bloom_level'])); ?></span>
                                                    <span class="px-1.5 py-0.5 rounded text-[8px] font-black uppercase <?php echo e($rec['priority'] === 'high' ? 'bg-rose-100 text-rose-700' : 'bg-amber-100 text-amber-700'); ?>">
                                                        <?php echo e($rec['priority']); ?> Priority
                                                    </span>
                                                </div>
                                                <h4 class="text-sm font-bold text-zinc-900 dark:text-zinc-100 mb-2"><?php echo e($rec['suggestion']); ?></h4>
                                                <p class="text-xs text-zinc-500 dark:text-zinc-400 mb-3 leading-relaxed"><?php echo e($rec['action']); ?></p>
                                                <div class="flex items-center gap-4">
                                                    <div class="flex-1 bg-zinc-200 dark:bg-zinc-700 h-1 rounded-full">
                                                        <div class="bg-indigo-500 h-1 rounded-full" style="width: <?php echo e($rec['mastery_percent']); ?>%"></div>
                                                    </div>
                                                    <span class="text-[10px] font-black text-indigo-500"><?php echo e($rec['mastery_percent']); ?>% Mastery</span>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="space-y-6">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $insights['improvement_areas']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $improvement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="p-6 rounded-2xl border border-zinc-100 dark:border-zinc-800 bg-zinc-50/30 dark:bg-zinc-800/5">
                                            <div class="flex items-center gap-3 mb-3">
                                                <span class="text-sm font-black text-zinc-900 dark:text-zinc-100"><?php echo e($improvement['area']); ?></span>
                                                <span class="px-2 py-0.5 rounded text-[8px] font-black uppercase <?php echo e($improvement['priority'] === 'high' ? 'bg-rose-100 text-rose-700' : 'bg-amber-100 text-amber-700'); ?>">
                                                    <?php echo e($improvement['priority']); ?> Priority
                                                </span>
                                            </div>
                                            <p class="text-xs text-zinc-500 dark:text-zinc-400 mb-4 leading-relaxed"><?php echo e($improvement['description']); ?></p>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($improvement['items_needing_work'])): ?>
                                                        <p class="text-xs text-zinc-500 font-medium">Flagged Items: <span class="text-zinc-900 dark:text-zinc-100 font-bold"><?php echo e($improvement['items_needing_work']); ?></span></p>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($improvement['weak_levels'])): ?>
                                                        <p class="text-xs text-zinc-500 font-medium">Critical Levels: <span class="text-zinc-900 dark:text-zinc-100 font-bold"><?php echo e(implode(', ', array_map('ucfirst', $improvement['weak_levels']))); ?></span></p>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                                        <td class="px-8 py-5">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <span class="text-xs font-bold text-zinc-700 dark:text-zinc-300"><?php echo e(substr($qId, 0, 12)); ?></span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-5">
                                            <div class="flex items-center gap-3">
                                        ...
                                        <td class="px-6 py-5 text-right">
                                            ...
                                            ?>
                                            <span class="px-3 py-1 rounded-full text-[10px] font-black uppercase border <?php echo e($diffClass); ?>">
