                ...
                <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    <div class="flex-1" data-aos="zoom-in">
                        <div class="relative group">
                            ...
                            <img src="<?php echo e(asset('landing/ai preview.png')); ?>" alt="AI Exam Preview" class="relative z-10 w-full h-auto drop-shadow-2xl rounded-2xl">
                        </div>
                    </div>
...
<?php endif; ?>
                    ...
                    <div class="flex-1 order-1 lg:order-2" data-aos="zoom-in">
                        <div class="relative group">
                            ...
                            <img src="<?php echo e(asset('landing/student mange.png')); ?>" alt="Student Management" class="relative z-10 w-full h-auto drop-shadow-2xl rounded-2xl">
                        </div>
                    </div>
                </div>
            </div>
