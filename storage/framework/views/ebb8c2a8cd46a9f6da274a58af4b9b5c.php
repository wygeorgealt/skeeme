...
<div class="guide-container">
    <div class="breadcrumb" data-aos="fade-down">
        <a href="<?php echo e(url('learn/documentation')); ?>">Documentation</a> / School Configuration
    </div>
    ...
    <section class="guide-content">
        ...
        <div class="next-section">
            ...
            <p>Learn to manage users and import data. Check out our <a href="<?php echo e(url('learn/documentation/user-management')); ?>">User Management</a> guide.</p>
        </div>
    </section>
</div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views\landing\learn\school-configuration.blade.php ENDPATH**/ ?>