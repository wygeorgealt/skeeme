...
<?php endif; ?>
                                            <span class="text-xs font-bold text-purple-700 dark:text-purple-300">
                                                <?php echo e($answer->isAIGraded() ? 'AI Analysis' : 'Auto-Marked'); ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($answer->getConfidenceScore()): ?>
                                                <span class="text-xs text-purple-500 ml-auto">Confidence: <?php echo e($answer->getConfidenceScore() * 100); ?>%</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($answer->feedback): ?>
                                            <p class="text-sm text-gray-700 dark:text-gray-300 mb-2">
                                                <span class="font-semibold">Feedback:</span> <?php echo e($answer->feedback); ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($answer->getGradingReasoning()): ?>
                                            <p class="text-sm text-gray-600 dark:text-gray-400 italic border-t border-purple-100 dark:border-purple-900/30 pt-2 mt-2">
                                                Reasoning: <?php echo e($answer->getGradingReasoning()); ?>
...
<?php /**PATH C:\Users\kritex\Herd\skeeme\resources\views/livewire/lecturer-exam-grading.blade.php ENDPATH**/ ?>