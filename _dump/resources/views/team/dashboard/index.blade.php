...
<div class="dashboard-container">
    ...
    <div class="dashboard-header">
        <div>
            ...
            <p class="subtitle">Welcome back, <strong>{{ auth()->user()->name }}</strong> ({{ auth()->user()->teamMember->role }})</p>
        </div>
    </div>
    ...
    <div class="metrics-row">
        <div class="metric-card">
            ...
            <div class="metric-content">
                ...
                <div class="metric-detail">{{ $metrics['active_users'] }} active</div>
            </div>
        </div>
        <div class="metric-card">
            ...
            <div class="metric-content">
                ...
                <div class="metric-value">${{ number_format($metrics['revenue_this_month'], 0) }}</div>
                <div class="metric-detail">{{ $metrics['active_subscriptions'] }} active subs</div>
            </div>
        </div>
        <div class="metric-card">
            ...
            <div class="metric-content">
                ...
                <div class="metric-value">{{ $metrics['total_schools'] }}</div>
                <div class="metric-detail">{{ $metrics['total_subscriptions'] }} subscriptions</div>
            </div>
        </div>
        <div class="metric-card">
            ...
            <div class="metric-content">
                ...
                <div class="metric-value">{{ $recentErrors->count() }}</div>
    ...
    <div class="admin-sections">
        ...
        <div class="admin-card">
            <div class="card-header">
                ...
                <a href="{{ route('team.users.index') }}" class="card-action-btn" title="Full User Management"><i class="fas fa-arrow-right"></i></a>
            </div>
        ...
        <div class="admin-card">
            <div class="card-header">
                ...
                <a href="{{ route('team.financial.dashboard') }}" class="card-action-btn" title="Financial Dashboard"><i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="card-content">
                <div class="feature-list">
                    <div class="feature-item">
        ...
        <div class="admin-card">
            <div class="card-header">
                ...
                <a href="{{ route('team.support.tickets.index') }}" class="card-action-btn" title="Support Management"><i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="card-content">
                <div class="feature-list">
                    <div class="feature-item">
                        <span class="feature-icon"><i class="fas fa-ticket-alt"></i></span>
                        <span class="feature-text">Support Tickets ({{ $contactMessages->count() }})</span>
                    </div>
                    <div class="feature-item">
                    ...
                    <div class="feature-item">
                        ...
                        <span class="feature-text">System Announcements ({{ $announcements->count() }})</span>
                    </div>
                    <div class="feature-item">
        ...
        <div class="admin-card">
            <div class="card-header">
                ...
                <a href="{{ route('team.analytics.dashboard') }}" class="card-action-btn" title="Analytics Dashboard"><i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="card-content">
                <div class="feature-list">
                    <div class="feature-item">
        ...
        <div class="admin-card">
            <div class="card-header">
                ...
                <a href="{{ route('team.monitoring.errors') }}" class="card-action-btn" title="System Health"><i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="card-content">
                <div class="feature-list">
                    <div class="feature-item">
                    ...
                    <div class="feature-item">
                        ...
                        <span class="feature-text">Error Logs ({{ $recentErrors->count() }})</span>
                    </div>
                    <div class="feature-item">
        ...
        <div class="admin-card">
            <div class="card-header">
                ...
                <a href="{{ route('team.settings.system') }}" class="card-action-btn" title="Settings Management"><i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="card-content">
                <div class="feature-list">
                    <div class="feature-item">
        ...
        <div class="admin-card">
            <div class="card-header">
                ...
                <a href="{{ route('team.content.pages') }}" class="card-action-btn" title="Content Management"><i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="card-content">
                <div class="feature-list">
                    <div class="feature-item">
            ...
            <div class="error-list">
                @forelse($recentErrors as $error)
                    <div class="error-item">
                        <div class="error-code">{{ $error->error_code ?? 'N/A' }}</div>
                        <div class="error-message">{{ substr($error->error_message, 0, 60) }}...</div>
                        <div class="error-time">{{ $error->created_at->diffForHumans() }}</div>
                    </div>
                @empty
                ...
                @forelse($announcements as $announcement)
                    <div class="announcement-item">
                        <div class="announcement-badge">
                            <span class="badge badge-{{ $announcement->priority ?? 'info' }}">
                                {{ ucfirst($announcement->priority ?? 'normal') }}
                            </span>
                        </div>
                        <div class="announcement-content">
                            <div class="announcement-title">{{ $announcement->title }}</div>
                            <div class="announcement-message">{{ substr($announcement->content ?? $announcement->message, 0, 80) }}...</div>
                            <div class="announcement-date">{{ $announcement->published_at?->diffForHumans() ?? $announcement->created_at?->diffForHumans() }}</div>
                        </div>
                    </div>
                @empty
            ...
            <div class="contact-list">
                @forelse($contactMessages as $message)
                    <div class="contact-item">
                        <div class="contact-avatar">{{ strtoupper(substr($message->name ?? $message->sender_name ?? 'U', 0, 1)) }}</div>
                        <div class="contact-content">
                            <div class="contact-name">{{ $message->name ?? $message->sender_name ?? 'Unknown' }}</div>
                            <div class="contact-email">{{ $message->email ?? $message->sender_email ?? 'N/A' }}</div>
                            <div class="contact-subject">{{ substr($message->subject ?? $message->message ?? '', 0, 100) }}</div>
                            <div class="contact-date">{{ $message->created_at->diffForHumans() }}</div>
                        </div>
