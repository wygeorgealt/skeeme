...
<div class="guide-container">
    <div class="breadcrumb" data-aos="fade-down">
        <a href="{{ url('learn/documentation') }}">Documentation</a> / AI Auto-Grading Workflow
    </div>
    ...
    <section class="guide-content">
        ...
        <div class="next-section">
            ...
            <p>Learn how to analyze exam results and track student performance. Check out our <a href="{{ url('learn/documentation/analytics-dashboard') }}">Analytics Dashboard</a> guide.</p>
        </div>
    </section>
</div>
