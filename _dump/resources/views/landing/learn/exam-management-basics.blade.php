...
<div class="guide-container">
    <div class="breadcrumb" data-aos="fade-down">
        <a href="{{ url('learn/documentation') }}">Documentation</a> / Exam Management Basics
    </div>
    ...
    <section class="guide-content">
        ...
        <div class="next-section">
            ...
            <p>Check out our <a href="{{ url('learn/documentation/ai-question-generation') }}">AI Question Generation</a> guide to create questions faster with AI assistance.</p>
        </div>
    </section>
</div>
