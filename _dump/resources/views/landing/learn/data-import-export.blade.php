...
@section('content')
    ...
    <div class="guide-container">
        ...
        <section class="guide-hero" data-aos="fade-up">
            ...
            <p>Efficiently import student and enrollment data into Skeeme. Export reports and analytics for external
                analysis and integration with other systems.</p>
            <p style="color: #9ca3af; font-size: 0.95rem;">â±ï¸ Estimated reading time: 16 minutes</p>
        </section>

        <section class="guide-content">
            <div class="section" data-aos="fade-up">
                <h2>Overview</h2>
                <p>Skeeme provides powerful import and export capabilities to move data in and out of the system. Whether
                    you're importing student rosters, syncing with your SIS, or exporting data for analysis, these tools
                    streamline your workflow.</p>
            ...
            <div class="section" data-aos="fade-up">
                ...
                <div class="step-box">
                    <h4>ðŸ“‹ Required Columns</h4>
                    <p><strong>Required:</strong> first_name, last_name, email, class</p>
                    <p><strong>Optional:</strong> student_id, date_of_birth, phone, address, parent_email, emergency_contact
                    </p>
                </div>

                <h3>Sample CSV Format</h3>
                <p
                    style="background: rgba(0,0,0,0.3); padding: 1rem; border-radius: 8px; font-family: monospace; font-size: 0.9rem; overflow-x: auto;">
                ...
                <div class="step-box">
                    <h4>ðŸ“¤ Importing Students</h4>
                    <p><strong>Step 1:</strong> Go to Admin â†’ User Management â†’ Students â†’ "Bulk Import"</p>
                ...
                <div class="tip-box">
                    <strong>ðŸ’¡ Pro Tip:</strong> Test import with a small sample first (10 students) to catch any format
                    issues before importing your full roster.
                </div>
            </div>
            ...
            <div class="section" data-aos="fade-up">
                ...
                <p>SIS (Student Information System) integration automatically syncs student enrollment data between your
                    school's SIS and Skeeme. This ensures:</p>
                <ul class="feature-list">
                ...
                <div class="step-box">
                    <h4>ðŸ”— Integration Setup</h4>
                    <p><strong>Step 1:</strong> Go to Admin â†’ Integrations â†’ SIS</p>
                ...
                <div class="warning-box">
                    <strong>âš ï¸ Important:</strong> Before enabling SIS sync, ensure field mapping is correct. Incorrect
                    mapping can overwrite Skeeme data with wrong information.
                </div>
            </div>
            ...
            <div class="section" data-aos="fade-up">
                ...
                <div class="step-box">
                    <h4>ðŸ‘¥ Export Steps</h4>
                    <p><strong>Step 1:</strong> Go to Admin â†’ User Management â†’ Students</p>
                ...
                <div class="tip-box">
                    <strong>ðŸ’¡ Pro Tip:</strong> Export data regularly for backup purposes. If something goes wrong, you
                    have recent backups to restore from.
                </div>
            </div>
            ...
            <div class="section" data-aos="fade-up">
                ...
                <div class="step-box">
                    <h4>ðŸ’¾ Backup Request</h4>
                    <p><strong>Step 1:</strong> Go to Admin â†’ Data Management â†’ Backups</p>
                ...
                <div class="warning-box">
                    <strong>âš ï¸ Important:</strong> Always backup before deleting any data. Deletions are permanent and
                    cannot be undone.
                </div>
            </div>
            ...
            <div class="section" data-aos="fade-up">
                ...
                <p>The API (Application Programming Interface) allows developers to build custom integrations with Skeeme:
                </p>
                <ul class="feature-list">
                ...
                <div class="step-box">
                    <h4>ðŸ” API Setup</h4>
                    <p><strong>Step 1:</strong> Go to Admin â†’ Integrations â†’ API</p>
            ...
            <div class="section" data-aos="fade-up">
                ...
                <p><strong>Solutions:</strong> Check column headers, ensure UTF-8 encoding, verify emails are unique,
                    confirm class names exist</p>
                ...
                <p><strong>Solutions:</strong> Verify credentials with SIS provider, test connection, check firewall/proxy
                    settings</p>
            </div>
            ...
            <div class="next-section">
                ...
                <p>Check out our full documentation or contact support at noreply@contact.skeeme.com for assistance with
