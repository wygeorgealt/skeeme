...
<div class="guide-container">
    <div class="breadcrumb" data-aos="fade-down">
        <a href="{{ url('learn/documentation') }}">Documentation</a> / Inviting Users
    </div>
...
bola.oladele@school.edu,oladele.parent@outlook.com,Mrs Oladele,Mother</div>
        ...
        <div class="section" data-aos="fade-up">
            ...
            <div class="next-section">
                ...
                <p>Head over to the <a href="{{ url('learn/documentation/creating-first-exam') }}">Creating Your First Exam</a> guide to get started.</p>
            </div>
        </div>
    </section>
</div>
